            ...
            if (player.hasPermission("ca.afk.self")) {
                if (args[0].equalsIgnoreCase("on")) {
                    if (!afkplayers.containsKey(player)) {
                        ...
                        Utils.setPlayerPrefix(player, plugin.getPrefix("Afk"), true);
                    } else {
                ...
                try {
                    ...
                    if (args[1].equalsIgnoreCase("on")) {
                        if (!afkplayers.containsKey(target)) {
                            ...
                            Utils.setPlayerPrefix(target, plugin.getPrefix("Afk"), true);
                        } else {
                        ...
                        if (args[1].equalsIgnoreCase("off")) {
                            if (afkplayers.containsKey(target)) {
                                ...
                                Utils.setPlayerPrefix(target, plugin.getPrefix("Standard"), true);
                            } else {
